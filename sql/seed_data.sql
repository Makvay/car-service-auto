...
-- 2. Insert Clients (RETURNING чтобы получить ID)
...
-- 3. Insert Cars (id клиентов будут 1,2,3,4,5)
...
-- 4. Insert Masters
INSERT INTO master.masters (employee_code, first_name, last_name, phone, email, specialization, hourly_rate, is_active, hire_date, created_at, updated_at) 
VALUES 
('MSTR001', 'Александр', 'Сергеев', '+7(900)111-11-11', 'alex@mail.ru', 'DIAGNOSTIC', 2500.00, TRUE, '2018-01-15', NOW(), NOW()),
('MSTR002', 'Дмитрий', 'Козлов', '+7(900)222-22-22', 'dmitry@mail.ru', 'ENGINE', 3000.00, TRUE, '2017-06-01', NOW(), NOW()),
('MSTR003', 'Мария', 'Волкова', '+7(900)333-33-33', 'maria@mail.ru', 'BODY', 2800.00, TRUE, '2019-03-20', NOW(), NOW()),
('MSTR004', 'Николай', 'Морозов', '+7(900)444-44-44', 'nikolay@mail.ru', 'ELECTRIC', 3200.00, TRUE, '2016-09-10', NOW(), NOW()),
('MSTR005', 'Екатерина', 'Соколова', '+7(900)555-55-55', 'ekaterina@mail.ru', 'GENERAL', 1500.00, TRUE, '2022-05-01', NOW(), NOW());

-- 5. Insert Claims (используем fk_client, fk_vehicle)
...
('CLM-2024-0002', 2, 2, 'DONE', 'Замена масла', 30000, 'NORMAL', TRUE, TRUE, NOW() - INTERVAL '7 days', NOW()),
...
-- 7. Insert Warehouse (сначала parts, потом inventory)
